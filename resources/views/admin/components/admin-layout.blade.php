...
<head>
    ...
    <title>{{ $title ?? 'DoctorApp - Admin' }}</title>
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="{{ route('admin.dashboard') }}" class="flex ms-2 md:me-24">
                    <img src="https://cdn-icons-png.flaticon.com/512/1752/1752772.png" class="h-8 me-3" alt="DoctorApp Logo" />
                    <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap">DoctorApp</span>
                </a>
            </div>
